...
Let's create a relational database with multiple tables for the deliveries of a restaurant. It will have multiples tables to store data about customers, recipes, deliveries, prices, etc. Find bellow all the steps followed to create this database.
