...
```
Apparently, there's no constrains in the recipe table for the column 'price'.

There's a risk that someone will input a new recipe but forgets to write the price

Let's add a constrain to prevent this
